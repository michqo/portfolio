...
export const SKILL_CATEGORIES: SkillCategory[] = [
  {
    ...
    items: [
      ...
      { label: "Next.js", projects: [PROJECTS.SUBNIFY] },
      {
        label: "TypeScript",
        projects: [PROJECTS.SUBNIFY],
        experience: [EXPERIENCE.BACKBONE, EXPERIENCE.RESCO],
      },
      { label: "Tailwind CSS", projects: [PROJECTS.SUBNIFY] },
      ...
      { label: "shadcn/ui", projects: [PROJECTS.SUBNIFY] },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "VS Code" },
      { label: "Figma" },
      { label: "Vercel", projects: [PROJECTS.SUBNIFY] },
      { label: "Postman" },
